    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$count_order}}</span></h4>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$count_member}}</span></h4>
                ...
                <div class="mt-1">
                    <ul class="list-inline main-chart mb-0">
                        <li class="list-inline-item chart-border-left me-0 border-0">
                            <h3 class="text-primary">$<span data-plugin="counterup">{{$incomes}}</span><span class="text-muted d-inline-block font-size-15 ms-3">Income</span></h3>
                        </li>
    ...
    <div class="col-xl-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @foreach($topsellingproduct as $producttop)
                <div class="row align-items-center g-0 mt-3">
                    <div class="col-sm-6">
                        <p class="text-truncate mt-1 mb-0"><i class="mdi mdi-circle-medium text-primary me-2"></i> {{$producttop->namaproduk}} </p>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="progress mt-1" style="height: 6px;">
                            ...
                            <div class="progress-bar progress-bar bg-primary" role="progressbar"
                                style="width: {{$producttop->percent}}%" aria-valuenow="{{$producttop->qty}}" aria-valuemin="0"
                                aria-valuemax="{{$producttop->qty}}"></div>
                            @elseif ($loop->index==1)
