    ...
    <div class="container">
       <div id="detail" class="row">
          ...
          <div id="detail-body" class="col-lg-7 col-xl-auto mb-5">
             ...
             <header class="mb-5">
                <div class="row align-items-center mb-3 g-md-3">
                   <div class="col-md-3 mb-3 mb-md-0">
                      <img src={{url("template/assets/img/".$roadmap->image_square)}} class="img-fluid rounded" alt="">
                   </div>
                   <div class="col-md-9">
                ...
                <div class="row small text-center align-items-md-center">
                   <div class="col-md-auto mb-2">
                      <button class="btn btn-outline-primary btn-sm text-uppercase"
                         style="pointer-events: none;">{{$roadmap->level}}</button>
                      <span class="pl-3">
             ...
             <!-- baris tentang kelas -->
             <h3 class="font-weight-bold">Tentang Roadmap</h3>
             <p class="text-justify mb-5">
               {!!$roadmap->text!!}
             </p>

             <!-- baris daftar materi -->
             <h3 class="font-weight-bold">Roadmap</h3>
             ...
             @foreach ($kelas_online_roadmap_detail as $detailitem)
             <div class="mb-1">
               ...
               @if (!empty($detailitem->courses))
                   @foreach ($detailitem->courses as $courses)
                   <div class="p-4 border-top">
                     {{$courses->title}} <a href="{{url('courses/'.$courses->id)}}" target="_blank">Open Courses</a>
                 </div>
                      ...
                      <div class="tab-content">
                         <div class="tab-pane fade show active" id="tab-beli">
                            <div class="container-fluid py-3">
                               <p class="mb-0"><del>Rp {{$roadmap->price_buy}},-</del></p>
                               <h3 class="mb-3">
                                  <strong>Rp {{$roadmap->price_buy}},-</strong> &nbsp; <i style="font-size: 16px;">53% Off</i>
                               </h3>
                               <p class="text-center">
                         ...
                         <div class="tab-pane fade" id="tab-sewa">
                            <div class="container-fluid py-3">
                               <p class="mb-0"><del>Rp {{$roadmap->price_rent}},-</del></p>
                               <h3 class="mb-3">
                                  <strong>Rp {{$roadmap->price_rent}},-</strong> &nbsp; <i style="font-size: 16px;">53% Off</i>
                               </h3>
                               <p class="text-center">
                                  <small class="text-danger" style="font-size: .7em;">
                                     <i class="bi bi-clock-fill"></i> Diskon sampai hari ini
