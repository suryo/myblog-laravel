...
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        <button type="button" class="close position-absolute top-0 right-0 m-2" data-dismiss="modal"
            aria-label="Close" style="z-index: 100;">
        ...
        <div class="modal-body p-4 p-lg-5">
            <div class="text-center">
                ...
                <form action="" class="text-left mb-4">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control border-left-0 pl-0"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control border-left-0 pl-0"
                ...
                <div>
                    Already have account? <a data-dismiss="modal" data-toggle="modal"
                        href="#modal-login">Login</a>
                </div>
            </div>
        </div>
    </div>
