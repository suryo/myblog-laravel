                             ...
                             <div class="row row-cols-1 row-cols-lg-3 g-xl-3">
                                <div class="col">
                                   ...
                                   <ul class="navbar-nav flex-column mb-4 mb-xl-0">
                                    ...
                                    <li class="nav-item"><a href={{url("courses")}} class="nav-link">{{$item->name}}</a></li>
                                    @endforeach
                                ...
                                <div class="col">
                                   ...
                                   <ul class="navbar-nav flex-column mb-4 mb-xl-0">
                                    ...
                                    <li class="nav-item"><a href={{url("courses")}} class="nav-link">{{$technology->name}}</a></li>
                                    @endforeach
                                   </ul>
                                </div>
                                <div class="col">
                                   ...
                                   <ul class="navbar-nav flex-column mb-4 mb-xl-0">
                                      <li class="nav-item">
                                         <a href="#" class="nav-link">
                                            ...
                                            <img src={{url("template/assets/img/square-new.png")}} width="20" height="auto" class="mr-2" alt=""> Kelas Terbaru
                                         </a>
                                      </li>
                                      <li class="nav-item">
                                         <a href="#" class="nav-link">
                                           <img src={{url("template/assets/img/square-free.png")}} width="20" height="auto" class="mr-2" alt=""> Kelas Gratis
                                         </a>
                                      </li>
                                      <li class="nav-item">
                                         <a href="#" class="nav-link">
                                           <img src={{url("template/assets/img/square-flashsale.png")}} width="20" height="auto" class="mr-2" alt=""> Flash Sale
                                         </a>
                                      </li>
                                      <li class="nav-item">
                                         <a href="#" class="nav-link">
                                           <img src={{url("template/assets/img/square-popular.png")}} width="20" height="auto" class="mr-2" alt=""> Popular
                                         </a>
                                      </li>
                                      <li class="nav-item">
                                         <a href="#" class="nav-link">
                                           <img src={{url("template/assets/img/square-mentor.png")}} width="20" height="auto" class="mr-2" alt=""> Mentor
                                         </a>
                                      </li>
                                      <li class="nav-item">
                                       <a href="#" class="nav-link">
                                         <img src={{url("template/assets/img/square-roadmap.png")}} width="20" height="auto" class="mr-2" alt=""> Roadmap
                                       </a>
                                    </li>
                                   </ul>
                                </div>
