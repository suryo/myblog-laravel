            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="{{url('fproducts')}}" class="nav-item nav-link">Shop</a>
                        <a href="{{url('fproducts')}}" class="nav-item nav-link">Shop Detail</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-angle-down mt-1"></i></a>
                            <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                <a href="{{url('fcart')}}" class="dropdown-item">Shopping Cart</a>
                                <a href="{{url('fcheckouts')}}" class="dropdown-item">Checkout</a>
                            </div>
                        </div>
