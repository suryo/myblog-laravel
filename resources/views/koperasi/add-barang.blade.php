...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('koperasibarang.add') }}" method="POST">
                        @csrf
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-2 col-form-label">id_category_barang :</label>
                            <div class="col-md-10">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="barang" value=""
                                    id="example-text-input" placeholder="barang">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="price" value=""
                                    id="example-text-input" placeholder="price">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="stock" value=""
                                    id="example-text-input" placeholder="stock">
                            </div>
                        </div>
