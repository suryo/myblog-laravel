...
@section('content')
    @component('common-components.breadcrumb')
        @slot('pagetitle') Kelas Online @endslot
        @slot('title') Roadmap @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-lg-12">
            <div>
                ...
                <a href={{url('kelasonline/create')}} type="button" class="btn btn-success waves-effect waves-light mb-3"><i
            ...
            <div class="table-responsive mb-4">
                <table class="table table-centered datatable dt-responsive nowrap table-card-list"
                    ...
                    <tbody>
                        @forelse ($kelasonlineroadmap as $item)
                        <tr>
                            <td>
                                <div class="form-check text-center font-size-16">
