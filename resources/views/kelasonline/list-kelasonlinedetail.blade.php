    ...
    <div class="row">
        <div class="col-lg-12">
            <div>
                ...
                <a href={{url('kelasonlinedetail/create')}} type="button" class="btn btn-success waves-effect waves-light mb-3"><i
                        class="mdi mdi-plus me-1"></i> Add New Topics</a>
            </div>
            <div class="table-responsive mb-4">
                <table class="table table-centered datatable dt-responsive nowrap table-card-list"
                    ...
                    <tbody>
                        @forelse ($kelasonlinedetail as $item)
                        <tr>
                            <td>
                                <div class="form-check text-center font-size-16">
                            ...
                            <td>
                                ...
                                <a href="{{ route('kelasonlinedetail.edit', $item->id) }}" class="px-3 text-primary"><i
