...
<form action="{{ route('product.update', $product_models->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('category') is-invalid @enderror"
                                    name="id_category_product" value="{{ old('id_category_product', $product_models->id_category_product) }}">
                            ...
                            <div class="form-group">
                                ...
                                name="product" value="{{ old('product', $product_models->product) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    ...
                                    rows="5"
                                   >{{ old('description', $product_models->description) }}</textarea>
