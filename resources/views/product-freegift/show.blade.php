...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('freegift.update', $product_free_gift_models[0]->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                ...
                                @if ($product->id == $product_free_gift_models[0]->product_id)
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="minorder" value="{{ $product_free_gift_models[0]->minimum_order }}"
                                    id="example-text-input" placeholder="$50">
                            </div>
                        </div>
                
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('freegift.index') }}"> Back</a>
