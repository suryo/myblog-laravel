...
<head>
    ...
    <link href="{{ url('koperasi/css/style.css') }}" rel="stylesheet">
</head>
...
<body>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light"
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        @foreach ($res_category as $category)
                            <a href="" class="nav-item nav-link">{{ $category->category_barang }}</a>
                        @endforeach
                    ...
                    <a class="text-decoration-none" href="">
                        <div class="cat-item d-flex align-items-center mb-4">
                            ...
                            <div class="flex-fill pl-3">
                                <h6>{{ $category->category_barang }}</h6>
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span
                class="bg-secondary pr-3">Product</span>
            <input id="search" class="form-control" type="text" value="">
            <input type="button" value="search" onclick="searchproduct()">
        </h2>
        <div id="barang" class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ url('koperasi/img/product-1.jpg') }}"
                                alt="">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{ $barang->barang }}</a>
    ...
    <script>
        var category = @json($res_category);
        var barang = @json($res_barang);

        function searchproduct() {
            console.log("test");
            var searchbarang = document.getElementById('search').value;
            var filtered = barang.filter(p => p.barang.includes(searchbarang))
            ...
            for (let index = 0; index < filtered.length; index++) {
                ...
                str += "                <img class='img-fluid w-100' src='{{ url('koperasi/img/product-1.jpg') }}'";
                str += "                    alt='>";

                str += "            </div>";
                str += "            <div class='text-center py-4'>";
                str += "                <div class='d-flex align-items-center mt-5 justify-content-center mt-2'>";
                str += "                    <h5>" + filtered[index].barang + "</h5>";
                str += "                </div>";
                str += "                <div class='d-flex align-items-center justify-content-center mt-2'>";
                str += "                    <h5>" + filtered[index].price + "</h5>";
                str += "                </div>";
                str += "            </div>";
                str += "        </div>";
                str += "    </div>";
            }
            document.getElementById('barang').innerHTML = str;
        }
    </script>
