...
class DiscountProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $product_models =  DB::select('select pm.*, pcm.product_collection_name, ptm.product_type_name,
        ...
        return view('discount-products/index', compact('product_models'))
    ...
    public function create()
    {
        ...
        return view('discount-products/create', compact('product_collection_models', 'product_type_models', 'product_form_models', 'product_package_models'));
    }
    ...
    public function show($id)
    {
        ...
        //dd($product_models);
        // return view('posts.index', compact('posts'));
        return view('discount-products/show', compact('product_models', 'pict'));
    }
    ...
    public function edit($id)
    {
        ...
        //dd($images);
        return view('discount-products.edit', compact(
            'product_models',
            'product_collection_models',
            'product_type_models',
            'product_form_models',
