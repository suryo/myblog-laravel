...
class FrontKelasEksklusifController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $res_kelas_eksklusif = DB::select("SELECT * from kelas_eksklusif order by id desc");

        $title = "News & Reviews";
		$pages = "news";
        return view('front/kelaseksklusif',compact('title','pages','res_kelas_eksklusif'));
    }
