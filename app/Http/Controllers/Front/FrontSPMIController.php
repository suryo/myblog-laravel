...
class FrontSPMIController extends Controller
{
    /**
    ...
    public function sejarah(Request $request)
    {
        ...
        return view('front/sejarah', compact('title', 'pages'))
    ...
    public function visimisi(Request $request)
    {
        ...
        return view('front/visimisi', compact('title', 'pages'));
        
    }
    public function fungsitugas(Request $request)
    {
         $title = 'fungsitugas';
        $pages = 'landing';

        return view('front/fungsitugas', compact('title', 'pages'));
    }
    public function modelmutu(Request $request)
    {
         $title = 'modelmutu';
        $pages = 'landing';

        return view('front/modelmutu', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function strukturorganisasi(Request $request)
    {
        ...
        return view('front/strukturorganisasi', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function berita(Request $request)
    {
        ...
        return view('front/berita', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function dokumenmutu(Request $request)
    {
         $title = 'dokumenmutu';
        $pages = 'landing';

        return view('front/dokumenmutu', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function dokumenspmi(Request $request)
    {
         $title = 'dokumenspmi';
        $pages = 'landing';

        return view('front/dokumenspmi', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function instrumenmutuinternal(Request $request)
    {
         $title = 'instrumenmutuinternal';
        $pages = 'landing';

        return view('front/instrumenmutuinternal', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function lemips(Request $request)
    {
         $title = 'lemips';
        $pages = 'landing';

        return view('front/lemips', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function lhpvm(Request $request)
    {
         $title = 'lhpvm';
        $pages = 'landing';

        return view('front/lhpvm', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function pkpj(Request $request)
    {
         $title = 'pkpj';
        $pages = 'landing';

        return view('front/pkpj', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function lhamips(Request $request)
    {
         $title = 'lhamips';
        $pages = 'landing';

        return view('front/lhamips', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    public function lbenchmark(Request $request)
    {
         $title = 'lbenchmark';
        $pages = 'landing';

        return view('front/lbenchmark', compact('title', 'pages'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
