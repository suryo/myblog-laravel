...
class FrontLandingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $coursestechnology = DB::select("SELECT *,(select count(*) from kelas_online as k where k.technology_id = t.id and k.status='published') as jumlah from kelas_online_technology as t");
