...
class RoadmapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $kelasonline =  DB::select("SELECT n.id, n.title,n.level,n.image_landscape,n.author,n.price_buy, n.price_rent, c.name, n.created_at from kelas_online as n inner join kelas_online_category as c on n.category_id = c.id");

        return view('lms-front/courses/list', compact('kelasonline','coursescategory', 'coursestechnology','roadmap'));
