...
class ProductVariantController extends Controller
{
    ...
    {
        $product_variant_models = Product_variant_model::latest()->get();

        // return view('posts.index', compact('posts'));
        return view('product-variants/index', compact('product_variant_models'))
    ...
    {
        $product_variant_models = Product_variant_model::find($id);
        return view('product-variants.show', compact('product_variant_models'));
    }
