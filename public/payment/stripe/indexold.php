...
$itemt =  "{\"description\": \"'".$arraykart[0]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshipp.",\"height\": 5,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[0]["harga"].",\"quantity\": ".$qity."},"."\r\n";
$itemr =  "{\"description\": \"'".$arraykart[1]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshippdua.",\"height\": 5,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[1]["harga"].",\"quantity\": ".$qitydua."}"."\r\n";
$item = $itemt.$itemr;
...
$item =  "{\"description\": \"'".$arraykart[0]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshipp.",\"height\": 5,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[0]["harga"].",\"quantity\": ".$qity."}"."\r\n";
//$item = $item.$itemmn;
