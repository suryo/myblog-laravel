...
$qity = $arraykart[$x]["qty"];
 ...
 $itemm ="{\"description\": \"'".$arraykart[$x]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshipp.",\"height\": 1,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[$x]["harga"].",\"quantity\": ".$qity."},"."\r\n";
...
$itemmn =  "{\"description\": \"'".$arraykart[$x]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshipp.",\"height\": 5,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[$x]["harga"].",\"quantity\": ".$qity."}"."\r\n";
$item = $item.$itemmn;


if($jmlarraycart == 1){
$berateasyshipp = 0;    
$berateasyshipp = $arraykart[0]["berat"] * $arraykart[0]["qty"];
$berateasyshippdua = $arraykart[1]["berat"] * $arraykart[1]["qty"];
$qity = $arraykart[0]["qty"];
$qitydua = $arraykart[1]["qty"];
$itemt =  "{\"description\": \"'".$arraykart[0]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshipp.",\"height\": 15,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[0]["harga"].",\"quantity\": ".$qity."},"."\r\n";
$itemr =  "{\"description\": \"'".$arraykart[1]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshippdua.",\"height\": 15,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[1]["harga"].",\"quantity\": ".$qitydua."}"."\r\n";
$item = $itemt.$itemr;
...
$item =  "{\"description\": \"'".$arraykart[0]["namaproduk"]."'\",\"sku\": \"sku\",\"actual_weight\": ".$berateasyshipp.",\"height\": 15,\"width\": 15,\"length\": 15,\"category\": \"Dry Food & Supplements\",\"declared_currency\": \"SGD\",\"declared_customs_value\": ".$arraykart[0]["harga"].",\"quantity\": ".$qity."}"."\r\n";
//$item = $item.$itemmn;
...
$sqlcoupon = "SELECT * FROM mastercoupon WHERE kodecoupon = '".$isicoupon."' AND iduser = '".$idsr."' ";
...
<style type="text/css">
	...
	<div class="container"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><h1>Loading</h1></div>


<form style="" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_xclick" />
<input type="hidden" name="business" value="dm@indraco.com" /> <!--Your Paypal Email-->
<input type="hidden" name="lc" value="US" />
<input type="hidden" name="item_name" value="Item Description" /> <!--ITEM NAME WITH DESCRIPTION-->
<input type="hidden" name="amount" value="<?php echo $totalorder ?>" /> <!--AMOUNT TO TRANSFER-->
<input type="hidden" name="currency_code" value="SGD" /> <!--CURRENCY CODE-->
